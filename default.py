...
import default_epy_module_0 as epy_module_0  # embedded python module
import pmt
...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.freq = freq = gr.tag_utils.python_to_tag((0, pmt.intern("key"), pmt.intern("value"), pmt.intern("src")))
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_var_to_msg_0, 'msgout'), (self.analog_sig_source_x_0, 'cmd'))
